...
module.exports = {
  ...
  networks: {
    thefluent: {
      url: "https://json-rpc.dev.thefluent.xyz//",
...
npx hardhat run scripts/deploy.js --network thefluent
...
const hre = require("hardhat");
const fs = require("fs");
const { encryptDataField, decryptNodeResponse } = require("@thefluent/utils");
...
async function main() {
  ...
  console.log("Transaction Receipt: ", \`Minting token has been success! Transaction hash: https://blockscout.dev.thefluent.xyz/tx/\${mint100TokensTx.hash}\`);
}
...
echo "Minting tokens..."
npx hardhat run scripts/mint.js --network thefluent
echo "Tokens minted."
...
async function main() {
  ...
  console.log("Transaction Response: ", \`Transfer token has been success! Transaction hash: https://blockscout.dev.thefluent.xyz/tx/\${transaction.hash}\`);
}
...
npx hardhat run scripts/transfer.js --network thefluent
